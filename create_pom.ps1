            ...
            <plugin>
                ...
                <executions>
                    <execution>
                        ...
                        <configuration>
                            <includeArtifactIds>javafx-controls,javafx-graphics,javafx-base,spring-context,spring-core,spring-beans,spring-aop,spring-expression,spring-jcl,spring-web,micrometer-observation,micrometer-commons,jackson-core,jackson-databind,jackson-annotations</includeArtifactIds>
